...
(add-hook 'lisp-mode-hook 'tl/lisp-mode-init)
...
(define-key help-map (kbd "l") 'tl/lispdoc) ; was view-lossage
;;----------------------------------------------------------------------------------------------------
...
;; (defun tl/start-slime ()
;;   (interactive)
;;   (unless (slime-connected-p)
;;     (save-excursion (slime))))
;; (add-hook 'slime-mode-hook 'tl/start-slime)
