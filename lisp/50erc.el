...
;; (define-key erc-mode-map (kbd "M-q") 'tl/unfill-line)
...
;; (define-key erc-mode-map [(meta ?g)] 'tl/switch-to-buffer)
...
;; (global-set-key (kbd "C-c n e") 'tl/toggle-erc-busy)
