...
(defun tl/evil-set-initial-state ()
  (loop for (mode . state) in
        '((comint-mode               . insert)
          ...
          (color-rg-mode             . evilified)
          (diff-mode                 . emacs)
          (docker-image-mode         . evilified)
          (docker-container-mode     . evilified)
          (docker-network-mode       . evilified)
          (docker-volume-mode        . evilified)
          (docker-machine-mode       . evilified)
          (eshell-mode               . insert)
          (eww-mode                  . emacs)
