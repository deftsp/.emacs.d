...
(add-to-list 'load-path "~/.emacs.d/packages/mldonkey-el-0.0.4b")
...
(setq mldonkey-image "~/Misc/pictures/Mldonkey.jpg")
...
(setq mldonkey-vd-sort-functions '((not mldonkey-vd-sort-dl-state)
                                   (not mldonkey-vd-sort-dl-percent)))

(setq mldonkey-vd-sort-fin-functions '(mldonkey-vd-sort-dl-number))
