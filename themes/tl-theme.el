...
(let ((base03  "#002b36")
  ...
  (custom-theme-set-faces
   ...
   '(org-level-2 ((t (:inherit outline-2   :foreground "#5ae274" :height 1.0))))
   ...
   `(org-link ((t (:inherit link :foreground "#4372bf" :underline t :weight normal))))
   ...
   '(org-agenda-calendar-sexp ((t (:foreground "#367292"))))
