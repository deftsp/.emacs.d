...
;;; mmm-mode
   ...
   `(org-link ((t (:foreground "#cec8b5" :underline nil :weight normal))))
   ...
   '(org-agenda-calendar-sexp ((t (:foreground "#33a4c6"))))
   ...
   '(font-lock-property-use-face ((t (:foreground "#a48fb3"))))
   '(font-lock-property-name-face ((t (:foreground "#a48fb3"))))
   ...
   `(lsp-bridge-ref-font-lock-match ((t (:foreground ,magenta :bold t))))
   ...
   ;; flyspell
   '(flyspell-incorrect ((t (:weight bold :underline (:style wave :color "#ffffff")))))
